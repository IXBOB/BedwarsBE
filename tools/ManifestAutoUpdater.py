...
label_beh_uuid.grid(row=2,column=1,sticky="nw")
label_res_uuid.grid(row=3,column=1,sticky="nw")
label_beh_ver_modapi.grid(row=4,column=1,sticky="nw")
label_beh_ver.grid(row=5,column=1,sticky="nw")
label_res_ver.grid(row=6,column=1,sticky="nw")
