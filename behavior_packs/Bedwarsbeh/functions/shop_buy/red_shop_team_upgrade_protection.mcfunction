 ...
 execute @s[scores={"分队"=1},l=299] ~~~ tellraw @s { "rawtext" : [ { "text" : "§lShop >> §cYou don't have enough levels." } ] }
 ...
 execute @a[tag=upgrade_red_protection] ~~~ tellraw @s { "rawtext" : [ { "text" : "§lShop >> §d§lYou upgraded the §r§6team PROTECTION" } ] }
