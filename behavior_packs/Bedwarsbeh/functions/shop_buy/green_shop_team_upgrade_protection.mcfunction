...
execute @s[scores={"分队"=4},l=299] ~~~ tellraw @s { "rawtext" : [ { "text" : "§lShop >> §cYou don't have enough levels" } ] }
...
execute @a[tag=upgrade_green_protection] ~~~ tellraw @s { "rawtext" : [ { "text" : "§lShop >> §d§lYou upgraded the §r§6team PROTECTION" } ] }
