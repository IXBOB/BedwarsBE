...
execute @s[scores={"分队"=3},l=399] ~~~ tellraw @s { "rawtext" : [ { "text" : "§cYou don't have enough levels." } ] }
...
execute @a[tag=upgrade_yellow_strength] ~~~ tellraw @s { "rawtext" : [ { "text" : "§d§lYou upgraded the §r§6team SHARPNESS" } ] }
