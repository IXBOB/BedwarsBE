...
execute @a[tag=upgrade_blue_strength] ~~~ tellraw @s { "rawtext" : [ { "text" : "§d§lYou upgraded the §r§6team SHARPNESS" } ] }
...
execute @e[type=armor_stand,name=main,scores={game_version=1}] ~~~ execute @a[tag=upgrade_blue_strength] ~~~ function team_upgrade_PROTECTIONandSHARPNESS
execute @e[type=armor_stand,name=main,scores={game_version=2}] ~~~ execute @a[tag=upgrade_blue_strength] ~~~ function team_upgrade_PROTECTIONandSHARPNESS_old2
