...
execute @s[scores={"分队"=4},l=99] ~~~ tellraw @s { "rawtext" : [ { "text" : "§lShop >> §cYou don't have enough levels." } ] }
...
execute @a[tag=upgrade_green_trigger] ~~~ tellraw @s { "rawtext" : [ { "text" : "§lShop >> §d§lYou purchased the §r§6team TRIGGER" } ] }
