...
execute @s[scores={"分队"=2},l=99] ~~~ tellraw @s { "rawtext" : [ { "text" : "§cYou don't have enough levels." } ] }
...
execute @a[tag=upgrade_blue_trigger] ~~~ tellraw @s { "rawtext" : [ { "text" : "§d§lYou purchased the §r§6team TRIGGER" } ] }
