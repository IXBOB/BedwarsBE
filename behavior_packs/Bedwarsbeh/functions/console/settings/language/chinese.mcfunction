...
summon bedwars:lobby_float_text "§e作者： IXBOB" -199 203 -199
summon bedwars:lobby_float_text "§b玩法指南" -197 201 -202
summon bedwars:lobby_info_about_cn -205.5 201 -205.5
summon bedwars:lobby_info_contact_cn -205.5 200 -205.5
...
execute @e[type=armor_stand,name=main,scores={guide_running=0}] ~~~ function lobby_guide/guide_board/cn/prepare