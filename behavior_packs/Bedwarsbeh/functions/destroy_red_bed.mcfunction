execute @s ~~~ detect 0 185 46 air 0 title @a[scores={"分队"=1}] title §c§lBED DESTROYED
...
execute @s[scores={desbed_tell_num=1}] ~~~ detect 0 185 46 air 0 tellraw @a { "rawtext" : [{ "text" : "\n§f§lBED DESTRUCTION >> §c§lred bed §fwas destroyed by: §b" },{ "selector" :  "@e[type=player,x=0,y=185,z=46,r=10,c=1,scores={分队=2}]" },{ "text" : "\n§r" }]}
execute @s[scores={desbed_tell_num=2}] ~~~ detect 0 185 46 air 0 tellraw @a { "rawtext" : [{ "text" : "\n§f§lBED DESTRUCTION >> §c§lred bed §fwas incinerated by: §b" },{ "selector" :  "@e[type=player,x=0,y=185,z=46,r=10,c=1,scores={分队=2}]" },{ "text" : "\n§r" }]}
execute @s[scores={desbed_tell_num=3}] ~~~ detect 0 185 46 air 0 tellraw @a { "rawtext" : [{ "text" : "\n§f§lBED DESTRUCTION >> §c§lred bed §fwas memed by: §b" },{ "selector" :  "@e[type=player,x=0,y=185,z=46,r=10,c=1,scores={分队=2}]" },{ "text" : "\n§r" }]}
execute @s[scores={desbed_tell_num=4}] ~~~ detect 0 185 46 air 0 tellraw @a { "rawtext" : [{ "text" : "\n§f§lBED DESTRUCTION >> §c§lred bed §fwas deep fried  by : §b" },{ "selector" :  "@e[type=player,x=0,y=185,z=46,r=10,c=1,scores={分队=2}]" },{ "text" : "\n§r" }]}
