#title胜利
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ title @a[scores={"分队"=1}] times 0 160 0
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ titleraw @a[scores={"分队"=1}] title { "rawtext" : [{"translate":"text.title.ingameinfo.victory"} ] }
#tellraw
function gameEND_tellraw_red
#firework -> 1
...
#title其它队失败
titleraw @a[scores={"分队"=!1}] title { "rawtext" : [{"translate":"text.title.ingameinfo.gameover"} ] }
#删除副标题
title @a subtitle §r
#胜场数+1
