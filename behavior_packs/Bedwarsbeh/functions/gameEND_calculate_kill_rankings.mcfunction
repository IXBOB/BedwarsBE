...
execute @a[scores={"分队"=1..4},tag=kill.FIRST,c=1] ~~~ tellraw @a {"rawtext":[{"translate":"text.tellraw.ingameinfo.first_killer"},{"selector":"@a[scores={分队=1..4},tag=kill.FIRST]"},{"text":" - "},{ "score" : { "name" : "@a[scores={分队=1..4},tag=kill.FIRST,c=1]" , "objective" : "击杀数"}}]}
...
execute @a[scores={"分队"=1..4},tag=kill.SECOND,c=1] ~~~ tellraw @a {"rawtext":[{"translate":"text.tellraw.ingameinfo.second_killer"},{"selector":"@a[scores={分队=1..4},tag=kill.SECOND]"},{"text":" - "},{ "score" : { "name" : "@a[scores={分队=1..4},tag=kill.SECOND,c=1]" , "objective" : "击杀数"}}]}
...
execute @a[scores={"分队"=1..4},tag=kill.THIRD,c=1] ~~~ tellraw @a {"rawtext":[{"translate":"text.tellraw.ingameinfo.third_killer"},{"selector":"@a[scores={分队=1..4},tag=kill.THIRD]"},{"text":" - "},{ "score" : { "name" : "@a[scores={分队=1..4},tag=kill.THIRD,c=1]" , "objective" : "击杀数"}}]}
