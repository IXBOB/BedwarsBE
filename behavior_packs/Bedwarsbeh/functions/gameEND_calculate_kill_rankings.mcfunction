...
execute @a[scores={"分队"=1..4},tag=kill.FIRST,c=1] ~~~ tellraw @a {"rawtext":[{"text":"     §e§l1st Killer §7"},{"selector":"@a[scores={分队=1..2},tag=kill.FIRST]"},{"text":" - "},{ "score" : { "name" : "@a[scores={分队=1..2},tag=kill.FIRST,c=1]" , "objective" : "击杀数"}}]}
...
execute @a[scores={"分队"=1..4},tag=kill.SECOND,c=1] ~~~ tellraw @a {"rawtext":[{"text":"     §6§l2nd Killer §7"},{"selector":"@a[scores={分队=1..2},tag=kill.SECOND]"},{"text":" - "},{ "score" : { "name" : "@a[scores={分队=1..2},tag=kill.SECOND,c=1]" , "objective" : "击杀数"}}]}
...
execute @a[scores={"分队"=1..4},tag=kill.THIRD,c=1] ~~~ tellraw @a {"rawtext":[{"text":"     §c§l3rd Killer §7"},{"selector":"@a[scores={分队=1..2},tag=kill.THIRD]"},{"text":" - "},{ "score" : { "name" : "@a[scores={分队=1..2},tag=kill.THIRD,c=1]" , "objective" : "击杀数"}}]}
