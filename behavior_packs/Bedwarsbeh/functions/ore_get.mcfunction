...
# 绿宝石拾取
execute @e[type=armor_stand,name=spawn.emerald,scores={emerald_count=80..}] ~~~ execute @e[type=bedwars:emerald_point_revolve,tag=emerald_point] ~~~ execute @e[type=player,r=1.8,c=1,scores={"分队"=1..4,"出局观战"=0}] ~~~ scoreboard players operation @s own_xp += @e[type=armor_stand,name=spawn.emerald,scores={emerald_count=80..}] emerald_count
execute @e[type=bedwars:emerald_point_revolve,tag=emerald_point] ~~~ execute @e[type=player,r=1.8,c=1,scores={"分队"=1..4,"出局观战"=0}] ~~~ execute @e[type=bedwars:emerald_point_revolve,tag=emerald_point] ~~~ kill @e[type=item,name=Emerald,r=1.8]
execute @e[type=bedwars:emerald_point_revolve,tag=emerald_point] ~~~ execute @e[r=1.8,c=1,scores={"分队"=1..4,"出局观战"=0}] ~~~ scoreboard players set @e[type=armor_stand,name=spawn.emerald] emerald_count 0
execute @e[type=bedwars:emerald_point_revolve,tag=emerald_point] ~~~ execute @e[r=1.8,c=1,scores={"分队"=1..4,"出局观战"=0}] ~~~ scoreboard players set @e[type=armor_stand,name=spawn.emerald] spawned_emerald 0