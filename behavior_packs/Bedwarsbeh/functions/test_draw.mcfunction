...
#title平局
execute @e[type=armor_stand,name=main,scores={gameSTART=2}] ~~~ titleraw @a[scores={"分队"=5}] title { "rawtext" : [{"translate":"text.title.ingameinfo.draw"} ] }
execute @e[type=armor_stand,name=main,scores={gameSTART=2}] ~~~ titleraw @a[scores={"分队"=5}] subtitle { "rawtext" : [{"translate":"text.subtitle.ingameinfo.draw"} ] }
#tellraw
...
execute @e[type=armor_stand,name=main,scores={gameSTART=2,after_g_en_exist=0}] ~~~ scoreboard players set @s after_g_en_exist 1