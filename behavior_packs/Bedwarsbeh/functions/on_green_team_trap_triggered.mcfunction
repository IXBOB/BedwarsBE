...
execute @s[scores={green_trap_1_id=3}] ~~~ execute @e[type=player,scores={"分队"=!4,"出局观战"=0},x=-58,y=176,z=5,dx=10,dy=22,dz=-26] ~~~ effect @s slowness 1 8 true
execute @s[scores={green_trap_1_id=3}] ~~~ execute @e[type=player,scores={"分队"=!4,"出局观战"=0},x=-58,y=176,z=5,dx=10,dy=22,dz=-26] ~~~ effect @s blindness 1 8 true
execute @s[scores={green_trap_1_id=4}] ~~~ execute @e[type=player,scores={"分队"=!4,"出局观战"=0},x=-58,y=176,z=5,dx=10,dy=22,dz=-26] ~~~ effect @s speed 1 8 true
execute @s[scores={green_trap_1_id=4}] ~~~ execute @e[type=player,scores={"分队"=!4,"出局观战"=0},x=-58,y=176,z=5,dx=10,dy=22,dz=-26] ~~~ effect @s jump_boost 1 8 true
