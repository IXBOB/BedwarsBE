...
execute @s[hasitem={location=slot.inventory,slot=0,item=bedwars:menu_pleasewait}] ~ ~ ~ function inventory_menu/menu3-op_menu/back
execute @s[hasitem={location=slot.inventory,slot=13,item=bedwars:menu_pleasewait}] ~ ~ ~ function inventory_menu/menu3-op_menu/remove_players
execute @s[hasitem={location=slot.inventory,slot=15,item=bedwars:menu_pleasewait}] ~ ~ ~ function inventory_menu/menu3-op_menu/add_players
