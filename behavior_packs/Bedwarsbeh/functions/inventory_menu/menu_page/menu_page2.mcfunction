...
execute @e[type=player,x=-200,y=200,z=-200,r=50,scores={分队=0,menu_page=2},hasitem={location=slot.inventory,slot=10,item=bedwars:menu_pleasewait}] ~ ~ ~ tag @s add particle_buy_none
execute @e[type=player,x=-200,y=200,z=-200,r=50,scores={分队=0,menu_page=2},hasitem={location=slot.inventory,slot=11,item=bedwars:menu_pleasewait}] ~ ~ ~ tag @s add particle_buy_villagerhappy
execute @e[type=player,x=-200,y=200,z=-200,r=50,scores={分队=0,menu_page=2},hasitem={location=slot.inventory,slot=12,item=bedwars:menu_pleasewait}] ~ ~ ~ tag @s add particle_buy_fire
