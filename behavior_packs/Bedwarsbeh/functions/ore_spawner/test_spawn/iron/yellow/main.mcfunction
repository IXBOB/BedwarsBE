...
execute @e[type=armor_stand,name=main,scores={游戏方式=1}] ~~~ execute @a[tag=on_iron_block_yellow] ~~~ function ore_get/iron_and_gold/gameway_1/yellow
execute @e[type=armor_stand,name=main,scores={游戏方式=2}] ~~~ execute @a[tag=on_iron_block_yellow] ~~~ function ore_get/iron_and_gold/gameway_2/yellow
