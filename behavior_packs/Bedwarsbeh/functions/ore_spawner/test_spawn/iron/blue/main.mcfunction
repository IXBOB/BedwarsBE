...
execute @e[type=armor_stand,name=main,scores={游戏方式=1}] ~~~ execute @a[tag=on_iron_block_blue] ~~~ function ore_get/iron_and_gold/gameway_1/blue
execute @e[type=armor_stand,name=main,scores={游戏方式=2}] ~~~ execute @a[tag=on_iron_block_blue] ~~~ function ore_get/iron_and_gold/gameway_2/blue
execute @a[tag=on_iron_block_blue,c=1] ~~~ function ore_get/iron_and_gold/reset_blue
