...
scoreboard players add @e[type=armor_stand,name=spawn.diamond_2,scores={diamond_count_2=..239}] diamond_count 30
...
execute @e[type=armor_stand,name=spawn.diamond_2,scores={diamond_count_2=30..,spawned_diam_2=..3}] ~~~ execute @e[type=bedwars:diamond_point_revolve,tag=diamond_point] ~~~ function ore_spawner/spawn_dropped_diamond/main
execute @e[type=armor_stand,name=spawn.diamond_2,scores={diamond_count_2=30..,spawned_diam_2=..7}] ~~~ scoreboard players add @s spawned_diam 1
