...
execute @e[type=armor_stand,scores={gameSTART=1,"显示事件"=11,"事件倒计时"=..0}] ~~~ scoreboard players set @a[scores={"分队"=1..4}] "分队" 5
execute @e[type=armor_stand,scores={gameSTART=1,"显示事件"=11,"事件倒计时"=..0}] ~~~ function test_draw
