execute @e[type=armor_stand,scores={gameSTART=1,"显示事件"=1,"事件倒计时"=122}] ~~~ scoreboard players set "§bDiamond II" "游戏显示" 120
...
execute @e[type=armor_stand,scores={gameSTART=1,"显示事件"=2,"事件倒计时"=..0}] ~~~ scoreboard players reset "§bDiamond II" "游戏显示"
