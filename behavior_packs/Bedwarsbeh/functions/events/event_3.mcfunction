execute @e[type=armor_stand,scores={gameSTART=1,"显示事件"=2,"事件倒计时"=123}] ~~~ scoreboard players set text.scoreboard.ingameinfo.event_3 "游戏显示" 120
...
execute @e[type=armor_stand,scores={gameSTART=1,"显示事件"=3,"事件倒计时"=..0}] ~~~ scoreboard players reset text.scoreboard.ingameinfo.event_3 "游戏显示"
