...
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ tellraw @a[tag=get.xp.game,x=0,y=200,z=0,c=1] { "rawtext" : [{"translate":"text.tellraw.ingameinfo.get_xp_time_played","with":{"score":{"name":"@s","objective":"xp_get_game"}}} ] }
...
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ tellraw @a[tag=get.xp.kill,x=0,y=200,z=0,c=1] { "rawtext" : [{"translate":"text.tellraw.ingameinfo.get_xp_kill","with":{"score":{"name":"@s","objective":"xp_get_kill"}}} ] }
...
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ tellraw @a[tag=get.xp.desbed,x=0,y=200,z=0,c=1] { "rawtext" : [{"translate":"text.tellraw.ingameinfo.get_xp_destroy_bed","with":{"score":{"name":"@s","objective":"xp_get_desbed"}}} ] }
...
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ execute @a[tag=get.coin.game,x=0,y=200,z=0,c=1] ~~~ scoreboard players operation @s "硬币数" += @e[type=armor_stand,name=main] coin_get_game
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ tellraw @a[tag=get.coin.game,x=0,y=200,z=0,c=1] { "rawtext" : [{"translate":"text.tellraw.ingameinfo.get_coin_time_played","with":{"score":{"name":"@s","objective":"coin_get_game"}}} ] }
...
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ execute @a[tag=get.coin.kill,x=0,y=200,z=0,c=1] ~~~ scoreboard players operation @s "硬币数" += @e[type=armor_stand,name=main] coin_get_kill
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ tellraw @a[tag=get.coin.kill,x=0,y=200,z=0,c=1] { "rawtext" : [{"translate":"text.tellraw.ingameinfo.get_coin_kill","with":{"score":{"name":"@s","objective":"coin_get_kill"}}} ] }
...
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ execute @a[tag=get.coin.desbed,x=0,y=200,z=0,c=1] ~~~ scoreboard players operation @s "硬币数" += @e[type=armor_stand,name=main] coin_get_desbed
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ tellraw @a[tag=get.coin.desbed,x=0,y=200,z=0,c=1] { "rawtext" : [{"translate":"text.tellraw.ingameinfo.get_coin_destroy_bed","with":{"score":{"name":"@s","objective":"coin_get_desbed"}}} ] }
