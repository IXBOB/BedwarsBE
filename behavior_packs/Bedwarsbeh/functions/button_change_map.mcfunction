...
#检测地图选择超过设定范围设为0
execute @e[type=armor_stand,name=main,scores={gameSTART=0,"地图选择"=5..}] ~~~ scoreboard players set @s "地图选择" 0
...
execute @e[type=player,x=-203,y=201,z=-196,r=3,c=1] ~~~ execute @s[tag=op] ~~~ execute @e[type=armor_stand,name=main,scores={gameSTART=0,"地图选择"=4}] ~~~ tellraw @a { "rawtext" : [ {"translate":"text.tellraw.waitinfo.change_map_success_4"} ] }
