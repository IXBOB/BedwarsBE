...
execute @e[type=player,x=-203,y=201,z=-196,r=3,c=1] ~~~ execute @s[tag=op] ~~~ execute @e[type=armor_stand,name=main,scores={gameSTART=0,"地图选择"=2}] ~~~ tellraw @a { "rawtext" : [ { "text" : "§f§lBEDWARS >> §eThe game map has been changed to §eDESERT" } ] }
