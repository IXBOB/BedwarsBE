...
execute @e[type=armor_stand,scores={gameSTART=1},name=main] ~~~ execute @e[type=player,tag=up_axe,scores={"斧等级"=2}] ~~~ tellraw @s { "rawtext" : [ { "text" : "§7Your axe level is now 2 §f(stone)" } ] }
