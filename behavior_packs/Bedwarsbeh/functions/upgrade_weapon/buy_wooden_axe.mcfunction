...
execute @e[type=armor_stand,scores={gameSTART=1},name=main] ~~~ execute @e[type=player,tag=up_axe,scores={"斧等级"=1}] ~~~ tellraw @s { "rawtext" : [ { "text" : "§f§lShop >> §7§lYour axe level is now 1 §f(wooden)(permanent)" } ] }
