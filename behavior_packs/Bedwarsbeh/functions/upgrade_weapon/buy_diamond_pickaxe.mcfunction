...
execute @e[type=armor_stand,scores={gameSTART=1},name=main] ~~~ execute @e[type=player,tag=up_pickaxe,scores={"镐等级"=4}] ~~~ tellraw @s { "rawtext" : [ { "text" : "§7Your pickaxe level is now 4 §f(diamond)" } ] }
