...
execute @e[type=armor_stand,scores={gameSTART=1},name=main] ~~~ execute @e[type=player,tag=up_pickaxe,scores={"镐等级"=1}] ~~~ tellraw @s { "rawtext" : [ { "text" : "§7Your pickaxe level is now 1 §f(wooden)(permanent)" } ] }
