...
execute @e[type=armor_stand,scores={gameSTART=1},name=main] ~~~ execute @e[type=player,tag=up_axe,scores={"斧等级"=3}] ~~~ tellraw @s { "rawtext" : [ { "text" : "§7Your axe level is now 3 §f(iron)" } ] }
