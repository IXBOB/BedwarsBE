...
execute @e[type=armor_stand,scores={gameSTART=1},name=main] ~~~ execute @e[type=player,tag=up_axe,scores={"斧等级"=4}] ~~~ tellraw @s { "rawtext" : [ { "text" : "§7Your axe level is now 4 §f(diamond)" } ] }
