...
execute @e[type=armor_stand,scores={gameSTART=1,game_version=2},name=main] ~~~ execute @e[type=player,tag=up_bow,scores={"弓等级"=2}] ~~~ function shop_purchase/give_items/old/give_bow3
