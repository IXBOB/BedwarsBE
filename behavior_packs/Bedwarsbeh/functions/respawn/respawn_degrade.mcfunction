...
#检测装备降级
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ execute @a[scores={able_to_respawn=1,"分队"=1..4},tag=degrade,tag=degrade_sword,tag=run_respawn_command] ~~~ tellraw @s { "rawtext" : [{"translate":"text.tellraw.ingameinfo.respawn_sword_degrade"} ] }
#检测装备降级
...
#检测装备降级
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ execute @a[scores={able_to_respawn=1,"分队"=1..4},tag=degrade,tag=degrade_pickaxe,tag=run_respawn_command] ~~~ tellraw @s { "rawtext" : [{"translate":"text.tellraw.ingameinfo.respawn_pickaxe_degrade"},{ "score" : { "name" : "@s" , "objective" : "镐等级"}}]}
#检测装备降级
...
#检测装备降级
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ execute @a[scores={able_to_respawn=1,"分队"=1..4},tag=degrade,tag=degrade_axe,tag=run_respawn_command] ~~~ tellraw @s { "rawtext" : [{"translate":"text.tellraw.ingameinfo.respawn_axe_degrade"},{ "score" : { "name" : "@s" , "objective" : "斧等级"}}]}
#检测装备降级
...
#检测装备降级
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ execute @a[scores={able_to_respawn=1,"分队"=1..4},tag=degrade,tag=degrade_armor,tag=run_respawn_command] ~~~ tellraw @s { "rawtext" : [ {"translate":"text.tellraw.ingameinfo.respawn_armor_degrade"},{ "score" : { "name" : "@s" , "objective" : "防具等级"}}]}
#检测装备降级
...
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ execute @a[scores={able_to_respawn=1,"分队"=1..4},tag=degrade,tag=degrade_xp,tag=run_respawn_command] ~~~ tellraw @s { "rawtext" : [{"translate":"text.tellraw.ingameinfo.respawn_lose_half_xp_levels"} ] }
