...
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ execute @e[type=player,scores={respawning=1,"重生时间"=..0,"分队"=1}] ~~~ scoreboard players set @s "重生时间" 100
#重生TP蓝
...
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ execute @e[type=player,scores={respawning=1,"重生时间"=..0,"分队"=2}] ~~~ scoreboard players set @s "重生时间" 100
#重生时间title
