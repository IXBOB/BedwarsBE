...
#淘汰后玩家actionbar
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ execute @a[x=-63,y=205,z=-63,dx=126,dy=10,dz=126,rx=90,rxm=-89] ~~~ detect ~ ~-1 ~ barrier 0 titleraw @s actionbar { "rawtext" : [{ "text" : "§f§l>> You are now a spectator <<" },{ "text" : "\n§r§fGame time:  " },{ "score" : { "name" : "@s" , "objective" : "game.time.min.2"}},{ "score" : { "name" : "@s" , "objective" : "game.time.min.1"}},{ "text" : " : " },{ "score" : { "name" : "@s" , "objective" : "game.time.sec.2"}},{ "score" : { "name" : "@s" , "objective" : "game.time.sec.1"}},{ "text" : "\n§r§c§lRed team remaining players: " },{"selector":"@a[scores={分队=1,存活=1}]"},{ "text" : "\n§r§b§lBlue team remaining players: " },{"selector":"@a[scores={分队=2,存活=1}]"},{ "text" : "\n§f>> Head up to go back to the lobby <<" } ] }
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ execute @a[x=-63,y=205,z=-63,dx=126,dy=10,dz=126,rx=90,rxm=-89,scores={"分队"=1..2,"存活"=0}] ~~~ detect ~ ~-1 ~ barrier 0 titleraw @s actionbar { "rawtext" : [{ "text" : "§7§l>> YOU DIED! You are now a spectator <<" },{ "text" : "\n§r§fGame time:  " },{ "score" : { "name" : "@s" , "objective" : "game.time.min.2"}},{ "score" : { "name" : "@s" , "objective" : "game.time.min.1"}},{ "text" : " : " },{ "score" : { "name" : "@s" , "objective" : "game.time.sec.2"}},{ "score" : { "name" : "@s" , "objective" : "game.time.sec.1"}},{"translate":"%%3%%4","with":{"rawtext":[{"selector":"@s[scores={分队=1,存活=0}]"},{"selector":"@s[scores={分队=1,存活=0}]"},{"text":"\n§r§fTeam: §c§lRED  §fRemaining members: §c"},{"selector":"@a[scores={分队=1,存活=1}]"},{"text":"\n§r§fTeam: §b§lBLUE  §fRemaining members: §b"},{"selector":"@a[scores={分队=2,存活=1}]"}]}},{ "text" : "\n§7>> Head up to go back to the lobby <<" } ] }
#clear红队淘汰玩家
...
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ execute @a[scores={"分队"=1..2,"存活"=1,"无敌时间"=20..},x=-63,y=171,z=-63,dx=126,dy=33,dz=126] ~~~ effect @s instant_health 1 255 true
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ execute @a[scores={"分队"=1..2,"存活"=1,"无敌时间"=0},x=-63,y=171,z=-63,dx=126,dy=33,dz=126] ~~~ tellraw @s { "rawtext" : [ { "text" : "§f§lBED WARS >> §b§lThe time of invincibility is over!" } ] }
...
execute @e[type=armor_stand,name=main,scores={gameSTART=0},tag=set.start.players.2] ~~~ execute @a[tag=op,tag=set.start.players.2] ~~~ tellraw @s { "rawtext" : [ { "text" : "§f§lBED WARS >> §r§cThe minimum number of players required to start the game has been set to 2" } ] }
execute @e[type=armor_stand,name=main,scores={gameSTART=0},tag=set.start.players.3] ~~~ execute @a[tag=op,tag=set.start.players.3] ~~~ tellraw @s { "rawtext" : [ { "text" : "§f§lBED WARS >> §r§cThe minimum number of players required to start the game has been set to 3" } ] }
execute @e[type=armor_stand,name=main,scores={gameSTART=0},tag=set.start.players.4] ~~~ execute @a[tag=op,tag=set.start.players.4] ~~~ tellraw @s { "rawtext" : [ { "text" : "§f§lBED WARS >> §r§cThe minimum number of players required to start the game has been set to 4" } ] }
execute @e[type=armor_stand,name=main,scores={gameSTART=0},tag=set.start.players.5] ~~~ execute @a[tag=op,tag=set.start.players.5] ~~~ tellraw @s { "rawtext" : [ { "text" : "§f§lBED WARS >> §r§cThe minimum number of players required to start the game has been set to 5" } ] }
execute @e[type=armor_stand,name=main,scores={gameSTART=0},tag=set.start.players.6] ~~~ execute @a[tag=op,tag=set.start.players.6] ~~~ tellraw @s { "rawtext" : [ { "text" : "§f§lBED WARS >> §r§cThe minimum number of players required to start the game has been set to 6" } ] }
execute @e[type=armor_stand,name=main,scores={gameSTART=0},tag=set.start.players.7] ~~~ execute @a[tag=op,tag=set.start.players.7] ~~~ tellraw @s { "rawtext" : [ { "text" : "§f§lBED WARS >> §r§cThe minimum number of players required to start the game has been set to 7" } ] }
execute @e[type=armor_stand,name=main,scores={gameSTART=0},tag=set.start.players.8] ~~~ execute @a[tag=op,tag=set.start.players.8] ~~~ tellraw @s { "rawtext" : [ { "text" : "§f§lBED WARS >> §r§cThe minimum number of players required to start the game has been set to 8" } ] }
...
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ tellraw @a[tag=get.xp.game,x=0,y=200,z=0,c=1] {"rawtext":[{"text":"§3Xp +"},{"score":{"name":"@s","objective":"xp_get_game"}},{"text":" (online)"}]}
...
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ tellraw @a[tag=get.xp.kill,x=0,y=200,z=0,c=1] {"rawtext":[{"text":"§3Xp +"},{"score":{"name":"@s","objective":"xp_get_kill"}},{"text":" (kill player)"}]}
...
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ tellraw @a[tag=get.xp.desbed,x=0,y=200,z=0,c=1] {"rawtext":[{"text":"§3Xp +"},{"score":{"name":"@s","objective":"xp_get_desbed"}},{"text":" (destroy bed)"}]}
...
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ tellraw @a[tag=get.coin.game,x=0,y=200,z=0,c=1] {"rawtext":[{"text":"§eCoin +"},{"score":{"name":"@s","objective":"coin_get_game"}},{"text":" (online)"}]}
...
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ tellraw @a[tag=get.coin.kill,x=0,y=200,z=0,c=1] {"rawtext":[{"text":"§eCoin +"},{"score":{"name":"@s","objective":"coin_get_kill"}},{"text":" (kill player)"}]}
...
execute @e[type=armor_stand,name=main,scores={gameSTART=1}] ~~~ tellraw @a[tag=get.coin.desbed,x=0,y=200,z=0,c=1] {"rawtext":[{"text":"§eCoin +"},{"score":{"name":"@s","objective":"coin_get_desbed"}},{"text":" (destroy bed)"}]}
