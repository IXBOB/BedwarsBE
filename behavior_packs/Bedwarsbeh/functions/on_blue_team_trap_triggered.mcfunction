...
execute @s[scores={blue_trap_1_id=2}] ~~~ execute @e[type=bedwars:base_entity_blue] ~~~ execute @e[type=player,scores={"分队"=!2,"出局观战"=0},r=22] ~~~ playanimation @s animation.bedwars_player_invisible default 0
