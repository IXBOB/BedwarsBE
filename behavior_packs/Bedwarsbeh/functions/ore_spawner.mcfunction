...
execute @s[scores={红家金time=..0}] ~~~ scoreboard players add @e[type=armor_stand,name=spawn.red_gold,scores={R_gold_count=..99}] R_gold_count 8
execute @s[scores={红家金time=..0}] ~~~ execute @e[type=armor_stand,name=spawn.red_gold,scores={R_gold_count=8..,R_spawned_gold=..11}] ~~~ structure load gold_ingot ~ 184 ~ 0_degrees none true false
execute @s[scores={红家金time=..0}] ~~~ execute @e[type=armor_stand,name=spawn.red_gold,scores={R_gold_count=8..,R_spawned_gold=..11}] ~~~ scoreboard players add @s R_spawned_gold 1
execute @s[scores={红家金time=..0}] ~~~ scoreboard players set @s 红家金time 6
#蓝家金生成
scoreboard players add @s 蓝家金time -1
execute @s[scores={蓝家金time=..0}] ~~~ scoreboard players add @e[type=armor_stand,name=spawn.blue_gold,scores={B_gold_count=..99}] B_gold_count 8
execute @s[scores={蓝家金time=..0}] ~~~ execute @e[type=armor_stand,name=spawn.blue_gold,scores={B_gold_count=8..,B_spawned_gold=..11}] ~~~ structure load gold_ingot ~ 184 ~ 0_degrees none true false
execute @s[scores={蓝家金time=..0}] ~~~ execute @e[type=armor_stand,name=spawn.blue_gold,scores={B_gold_count=8..,B_spawned_gold=..11}] ~~~ scoreboard players add @s B_spawned_gold 1
execute @s[scores={蓝家金time=..0}] ~~~ scoreboard players set @s 蓝家金time 6
#黄家金生成
scoreboard players add @s 黄家金time -1
execute @s[scores={黄家金time=..0}] ~~~ scoreboard players add @e[type=armor_stand,name=spawn.yellow_gold,scores={Y_gold_count=..99}] Y_gold_count 8
execute @s[scores={黄家金time=..0}] ~~~ execute @e[type=armor_stand,name=spawn.yellow_gold,scores={Y_gold_count=8..,Y_spawned_gold=..11}] ~~~ structure load gold_ingot ~ 184 ~ 0_degrees none true false
execute @s[scores={黄家金time=..0}] ~~~ execute @e[type=armor_stand,name=spawn.yellow_gold,scores={Y_gold_count=8..,Y_spawned_gold=..11}] ~~~ scoreboard players add @s Y_spawned_gold 1
execute @s[scores={黄家金time=..0}] ~~~ scoreboard players set @s 黄家金time 6
#绿家金生成
scoreboard players add @s 绿家金time -1
execute @s[scores={绿家金time=..0}] ~~~ scoreboard players add @e[type=armor_stand,name=spawn.green_gold,scores={G_gold_count=..99}] G_gold_count 8
execute @s[scores={绿家金time=..0}] ~~~ execute @e[type=armor_stand,name=spawn.green_gold,scores={G_gold_count=8..,G_spawned_gold=..11}] ~~~ structure load gold_ingot ~ 184 ~ 0_degrees none true false
execute @s[scores={绿家金time=..0}] ~~~ execute @e[type=armor_stand,name=spawn.green_gold,scores={G_gold_count=8..,G_spawned_gold=..11}] ~~~ scoreboard players add @s G_spawned_gold 1
execute @s[scores={绿家金time=..0}] ~~~ scoreboard players set @s 绿家金time 6
#钻石生成
