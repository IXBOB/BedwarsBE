...
execute @s[type=armor_stand,scores={钻石time=..0}] ~~~ execute @e[type=armor_stand,name=spawn.diamond_1,scores={diamond_count_1=30..,spawned_diam_1=..7}] ~~~ execute @e[type=bedwars:diamond_generate_point_revolve,tag=diamond_generate_point_1] ~~~ structure load diamond ~ ~ ~ 0_degrees none true false
...
execute @s[type=armor_stand,scores={钻石time=..0}] ~~~ execute @e[type=armor_stand,name=spawn.diamond_2,scores={diamond_count_2=30..,spawned_diam_2=..7}] ~~~ execute @e[type=bedwars:diamond_generate_point_revolve,tag=diamond_generate_point_2] ~~~ structure load diamond ~ ~ ~ 0_degrees none true false
...
execute @s[type=armor_stand,scores={钻石time=..0}] ~~~ execute @e[type=armor_stand,name=spawn.diamond_3,scores={diamond_count_3=30..,spawned_diam_3=..7}] ~~~ execute @e[type=bedwars:diamond_generate_point_revolve,tag=diamond_generate_point_3] ~~~ structure load diamond ~ ~ ~ 0_degrees none true false
...
execute @s[type=armor_stand,scores={钻石time=..0}] ~~~ execute @e[type=armor_stand,name=spawn.diamond_4,scores={diamond_count_4=30..,spawned_diam_4=..7}] ~~~ execute @e[type=bedwars:diamond_generate_point_revolve,tag=diamond_generate_point_4] ~~~ structure load diamond ~ ~ ~ 0_degrees none true false
...
execute @s[type=armor_stand,scores={绿宝石time=..0}] ~~~ execute @e[type=armor_stand,name=spawn.emerald,scores={emerald_count=80..,spawned_emerald=..3}] ~~~ execute @e[type=bedwars:emerald_generate_point_revolve,tag=emerald_generate_point] ~~~ structure load emerald ~ ~ ~ 0_degrees none true false
