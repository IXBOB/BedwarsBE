...
#玩家瞬间恢复
execute @e[type=armor_stand,name=main,scores={gameSTART=2}] ~~~ effect @a[scores={"分队"=1..2}] instant_health 15 255 true
#重置game_uid(游戏对局内uid)
execute @e[type=armor_stand,name=main,scores={gameSTART=2}] ~~~ scoreboard players reset @a game_uid
#增加总游戏数
scoreboard players add @a[scores={"分队"=1..2}] "总游戏数" 1
