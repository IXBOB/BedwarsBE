...
#倒计时0 title
titleraw @a title { "rawtext" : [{"translate":"text.title.ingameinfo.game_start"} ] }
#倒计时0 subtitle
...
#剑等级 -> 1
scoreboard players set @a[scores={"分队"=1..4}] "剑等级" 1
#镐等级 -> 0
...
tag @a remove degrade
#无敌时间 -> 60
scoreboard players set @a[scores={"分队"=1..4}] "无敌时间" 60
#tellraw获得无敌时间
execute @a[scores={"分队"=1..4}] ~~~ tellraw @s { "rawtext" : [{"translate":"text.tellraw.ingameinfo.get_invincibility"} ] }
#击杀数 -> 0
execute @a[scores={"分队"=1..4}] ~~~ scoreboard players set @s "击杀数" 0
#游戏开始tellraw游戏玩法
execute @s[scores={"游戏模式"=1}] ~~~ tellraw @a { "rawtext" : [{"translate":"text.tellraw.ingameinfo.play_guide_mode_1_line1"},{"text":"\n"},{"translate":"text.tellraw.ingameinfo.play_guide_mode_1_line2"},{"text":"\n"},{"translate":"text.tellraw.ingameinfo.play_guide_mode_1_line3"},{"text":"\n"},{"translate":"text.tellraw.ingameinfo.play_guide_mode_1_line4"},{"text":"\n"},{"translate":"text.tellraw.ingameinfo.play_guide_mode_1_line5"},{"text":"\n"},{"translate":"text.tellraw.ingameinfo.play_guide_mode_1_line6"},{"text":"\n"},{"translate":"text.tellraw.ingameinfo.play_guide_mode_1_line7"},{"text":"\n"},{"translate":"text.tellraw.ingameinfo.play_guide_mode_1_line8"},{"text":"\n"},{"translate":"text.tellraw.ingameinfo.play_guide_mode_1_line9"} ] }
execute @s[scores={"游戏模式"=2}] ~~~ tellraw @a { "rawtext" : [{"translate":"text.tellraw.ingameinfo.play_guide_mode_2_line1"},{"text":"\n"},{"translate":"text.tellraw.ingameinfo.play_guide_mode_2_line2"},{"text":"\n"},{"translate":"text.tellraw.ingameinfo.play_guide_mode_2_line3"},{"text":"\n"},{"translate":"text.tellraw.ingameinfo.play_guide_mode_2_line4"},{"text":"\n"},{"translate":"text.tellraw.ingameinfo.play_guide_mode_2_line5"},{"text":"\n"},{"translate":"text.tellraw.ingameinfo.play_guide_mode_2_line6"},{"text":"\n"},{"translate":"text.tellraw.ingameinfo.play_guide_mode_2_line7"},{"text":"\n"},{"translate":"text.tellraw.ingameinfo.play_guide_mode_2_line8"},{"text":"\n"},{"translate":"text.tellraw.ingameinfo.play_guide_mode_2_line9"} ] }
#疾速模式提示床将自毁
execute @s[scores={"游戏模式"=2}] ~~~ tellraw @a { "rawtext" : [{"translate":"text.tellraw.ingameinfo.event_rush_bed_self_destroyed_warn"} ] }
#给予木剑
replaceitem entity @a[scores={"分队"=1..4}] slot.hotbar 0 bedwars:wooden_sword 1 0 {"minecraft:item_lock":{"mode":"lock_in_inventory"},"minecraft:keep_on_death":{}}
#给予剪刀
replaceitem entity @a[scores={"分队"=1..4}] slot.hotbar 1 bedwars:shears 1 0 {"minecraft:item_lock":{"mode":"lock_in_inventory"},"minecraft:keep_on_death":{}}
#replaceitem红队皮革护甲
replaceitem entity @a[scores={"分队"=1}] slot.armor.head 0 bedwars:red_team_helmet 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}
replaceitem entity @a[scores={"分队"=1}] slot.armor.chest 0 bedwars:red_team_chestplate 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}
replaceitem entity @a[scores={"分队"=1}] slot.armor.legs 0 bedwars:red_team_leggings 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}
replaceitem entity @a[scores={"分队"=1}] slot.armor.feet 0 bedwars:red_team_boots 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}
#replaceitem蓝队皮革护甲
replaceitem entity @a[scores={"分队"=2}] slot.armor.head 0 bedwars:blue_team_helmet 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}
replaceitem entity @a[scores={"分队"=2}] slot.armor.chest 0 bedwars:blue_team_chestplate 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}
replaceitem entity @a[scores={"分队"=2}] slot.armor.legs 0 bedwars:blue_team_leggings 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}
replaceitem entity @a[scores={"分队"=2}] slot.armor.feet 0 bedwars:blue_team_boots 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}
#replaceitem黄队皮革护甲
replaceitem entity @a[scores={"分队"=3}] slot.armor.head 0 bedwars:yellow_team_helmet 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}
replaceitem entity @a[scores={"分队"=3}] slot.armor.chest 0 bedwars:yellow_team_chestplate 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}
replaceitem entity @a[scores={"分队"=3}] slot.armor.legs 0 bedwars:yellow_team_leggings 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}
replaceitem entity @a[scores={"分队"=3}] slot.armor.feet 0 bedwars:yellow_team_boots 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}
#replaceitem绿队皮革护甲
replaceitem entity @a[scores={"分队"=4}] slot.armor.head 0 bedwars:green_team_helmet 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}
replaceitem entity @a[scores={"分队"=4}] slot.armor.chest 0 bedwars:green_team_chestplate 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}
replaceitem entity @a[scores={"分队"=4}] slot.armor.legs 0 bedwars:green_team_leggings 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}
replaceitem entity @a[scores={"分队"=4}] slot.armor.feet 0 bedwars:green_team_boots 1 0 {"minecraft:item_lock":{"mode":"lock_in_slot"},"minecraft:keep_on_death":{}}
#红队存在-> 1
execute @a[scores={"分队"=1}] ~~~ scoreboard players set @e[type=armor_stand,name=main,scores={starting=1}] "红队存在" 1
#黄队存在-> 1
execute @a[scores={"分队"=2}] ~~~ scoreboard players set @e[type=armor_stand,name=main,scores={starting=1}] "黄队存在" 1
#蓝队存在-> 1
