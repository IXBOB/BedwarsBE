...
execute @s[scores={red_trap_1_id=2}] ~~~ execute @e[type=bedwars:base_entity_red] ~~~ execute @e[type=player,scores={"分队"=!1,"出局观战"=0},r=22] ~~~ playanimation @s animation.bedwars_player_invisible default 0
